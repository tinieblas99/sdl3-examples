...
| `sdl3-9grid-tiled` | SDL3 9-grid tiled rendering demo. A generated gothic PNG is used for scalable, tiled UI window borders. |
...
# SDL3 9-grid tiled panel example
cd ../sdl3-9grid-tiled
python3 generate_gothic_panel.py
cmake -S . -B build -DCMAKE_BUILD_TYPE=Release
cmake --build build
./build/sdl3_9grid_tiled_example
